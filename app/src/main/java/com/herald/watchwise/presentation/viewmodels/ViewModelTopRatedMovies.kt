...
import com.herald.watchwise.domain.use_cases.use_cases_remote.TopRatedMoviesUseCase
 ...
 * It gets and holds the Top-Rated Movies List
...
class ViewModelTopRatedMovies @Inject constructor(
    ...
    /**
     * [_state] this value is private so it won't be updated any where else
     * and it holds the state of the movie whether it's loading or fetched data or error
     * [state] is a public value and it's equal to [_state] but it can't be updated
